pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/CLee002/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('leecf2-225')   // <---- Change this to match your kubernetes cluster credentials
    }
